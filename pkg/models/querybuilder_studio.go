...
func (qb *StudioQueryBuilder) Create(newStudio Studio, tx *sqlx.Tx) (*Studio, error) {
	...
	result, err := tx.NamedExec(
		`INSERT INTO studios (image, checksum, name, url, parent_id, stash_id, created_at, updated_at)
                VALUES (:image, :checksum, :name, :url, :parent_id, :stash_id, :created_at, :updated_at)
		`,
		newStudio,
	)
	if err != nil {
